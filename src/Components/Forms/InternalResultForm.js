    ...
    <main className="internal">
      ...
      <section className="form__head">
        <form className="w-full gap-4 md:flex">
          <select
            className="mb-4 block h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-violet-900 light:border-slate-200 light:caret-inherit light:focus:border-violet-400 light:active:border-violet-400 md:w-1/3"
        ...
        <form className="internal__body__form">
          ...
          {internal.length && disabled ? (
            <div className="flex gap-4">
              ...
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-violet-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-red-700 focus:bg-violet-900 light:border-violet-300 light:bg-violet-900 light:text-violet-100 light:hover:bg-red-700"
