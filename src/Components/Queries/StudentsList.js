...
const StudentsList = () => {
  ...
  return (
    <main className="student">
      <h2 className="mb-2 mt-3 text-6xl font-bold text-violet-950 underline decoration-inherit decoration-2 underline-offset-4 light:mt-0 light:text-slate-400">
        Students List
      </h2>
