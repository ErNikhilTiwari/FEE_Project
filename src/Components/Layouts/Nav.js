...
const Nav = () => {
  ...
  return (
    <nav className="z-0 hidden h-full flex-col justify-stretch bg-slate-950 px-4 py-4 text-slate-100 light:bg-gradient-to-b light:from-slate-800  light:to-slate-950 lg:flex ">
